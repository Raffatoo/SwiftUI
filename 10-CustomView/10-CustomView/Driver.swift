...
let mercedes = Team(color: Color(red: 79.0/255.0, green: 164.0/255.0, blue: 161.0/255.0), imageName: "car_mercedes", escuderia:"Mercedes")
let ferrari = Team(color: Color(red: 231.0/255.0, green: 50.0/255.0, blue: 40.0/255.0), imageName: "car_ferrari", escuderia:"Ferrari")
let redbull = Team(color: Color(red: 34.0/255.0, green: 44.0/255.0, blue: 54.0/255.0), imageName: "car_redbull", escuderia:"Redbull")
let renault = Team(color: Color(red: 240.0/255.0, green: 238.0/255.0, blue: 95.0/255.0), imageName: "car_renault", escuderia:"Renoult")
let mclaren = Team(color: Color(red: 240.0/255.0, green: 172.0/255.0, blue: 61.0/255.0), imageName: "car_mclaren", escuderia:"Mclaren")
